...
export default function Registration() {
  ...
  const courses = [
    ...
    { id: 'ENG101', name: 'English Composition', credits: 3, description: 'Developing writing skills for academic and professional contexts.' },
    ...
    { id: 'BIO101', name: 'Biology I', credits: 4, description: 'Introduction to biological concepts and principles.' },
    { id: 'HIST101', name: 'World History', credits: 3, description: 'Survey of major historical events and developments.' }
  ];
